...
<main id="main">
    ...
    <div class="breadcrumbs">
      <div class="page-header d-flex align-items-center" style="background-image: url('{{asset($services[1]->image_2)}}');">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="card">
              ...
              <h3><a href="{{url('service-details/'.$services[0]->id)}}">{{$services[0]->title_2 }}</a></h3>
